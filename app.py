...
if "ع" in lang:
    ...
    if st.button("🚀 تشغيل خوارزمية التحليل الذكي"):
        with st.spinner("جاري معالجة بيانات التربة والمحصول عبر خوارزميات الزراعة الذكية..."):
            ...
            * 🧪 **الجرعة المثالية الموصى بها:** استخدام **{hydrogel_needed_kg:,.1f} كغ** موزة على عمق منطقة الجذر الحيوية.
            * 🌱 **الأثر الاقتصادي:** رفع كفاءة امتصاص الأسمدة المُقدرة بـ ({total_fertilizer:,.1f} كغ) وتقليل فقدان العناصر بالترشيح.
            """)

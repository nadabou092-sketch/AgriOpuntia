...
# --- 3. القائمة الجانبية (Sidebar) والإعدادات ---
...
# --- 4. قواميس الترجمة والبيانات المحسوبة ---
t = {
    "العربية": {
        "title": "AgriOpuntia 🇩🇿",
        ...
        "fert_label": "كمية الأسمدة الموصى بها للمتر المربع (كغ/م²):",
    ...
    "Français": {
        ...
        "card1_text": "<b>• Source:</b> Extrait naturel de figuier de barbarie.<br><b>• Fonction:</b> Rétention d'eau et de nutriments autour des racines.",
...
# --- 5. تنسيق التصميم العصري (Eye-Friendly CSS) ---
st.markdown(f"""
<style>
    .stApp {{
...
# --- 7. مدخلات القائمة الجانبية (Inputs) ---
...
# --- 11. إرشادات وتوجيهات الطقس الفورية ---
st.markdown("---")
...
report_content = (
    ...
    f"Soil: {soil_type}\n"
    f"Area: {area} m²\n"
    f"Hydrogel: {hydrogel_needed_kg:.1f} kg\n"
    f"Fertilizer: {total_crop_fertilizer_kg:.1f} kg"
)
